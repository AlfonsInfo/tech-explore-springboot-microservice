...
import tech.explore.microservice.loans.mapper.AccountsMapper
import tech.explore.microservice.loans.mapper.CustomerMapper
import tech.explore.microservice.loans.repository.AccountsRepository
import tech.explore.microservice.loans.repository.CustomersRepository
...
//                )
    ...
    private fun createNewAccount(customer: CustomerEntity): AccountsEntity? {
        ...
        newAccount.accountType = LoansConstants.SAVINGS
        newAccount.branchAddress = LoansConstants.ADDRESS
        return newAccount
    }
